<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patrasnotes.aspx.cs" Inherits="StudentRoom.topics.patras.patrasnotes" %>

<!doctype html>
<html>
<head>
<meta charset="utf-8">
<title>Πανεπιστήμιο Πατρών</title>
...
<link href="patrasnotes.css" rel="stylesheet">
...
<img src="images/University_of_Patras_(seal).png" id="ioannina_icon" alt="">
</div>
<div id="wb_">
<span style="color:#000000;font-family:Candara;font-size:19px;"><strong><a href="./patras.aspx" class="black_link">Πανεπιστήμιο Πατρών</a></strong></span>
</div>
...
<div id="button_discussions" class="RollOverLayer" style="left:10px;top:3px;width:116px;height:34px;z-index:4;" onclick="window.location.href='./patras.aspx';return false;">
<div id="wb_button_discussions_text">
<span style="color:#000000;font-family:Calibri;font-size:15px;">Συζητήσεις</span>
</div>
</div>
<div id="button_notes" class="RollOverLayerSelected" style="left:126px;top:3px;width:116px;height:34px;z-index:5;" onclick="window.location.href='./patrasnotes.aspx';return false;">
