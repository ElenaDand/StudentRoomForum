<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="macedonianotes.aspx.cs" Inherits="StudentRoom.topics.macedonia.macedonianotes" %>

<!doctype html>
<html>
<head>
<meta charset="utf-8">
<title>Πανεπιστήμιο Μακεδονίας</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link href="base/jquery-ui.min.css" rel="stylesheet">
<link href="font-awesome.min.css" rel="stylesheet">
<link href="StudentRoom.css" rel="stylesheet">
<link href="macedonianotes.css" rel="stylesheet">
...
<img src="images/macedonia.png" id="ioannina_icon" alt="">
</div>
<div id="wb_">
<span style="color:#000000;font-family:Candara;font-size:19px;"><strong><a href="./macedonia.aspx" class="black_link">Πανεπιστήμιο Μακεδονίας</a></strong></span>
</div>
...
<div id="button_discussions" class="RollOverLayer" style="left:10px;top:3px;width:116px;height:34px;z-index:4;" onclick="window.location.href='./macedonia.aspx';return false;">
<div id="wb_button_discussions_text">
<span style="color:#000000;font-family:Calibri;font-size:15px;">Συζητήσεις</span>
</div>
</div>
<div id="button_notes" class="RollOverLayerSelected" style="left:126px;top:3px;width:116px;height:34px;z-index:5;" onclick="window.location.href='./macedonianotes.aspx';return false;">
...
<div id="wb_FontAwesomeIcon1" style="display:inline-block;width:23px;height:20px;text-align:center;z-index:16;">
<div id="FontAwesomeIcon1" style="cursor:pointer;"><i class="fa fa-arrow-circle-o-up"></i></div>
</div>
