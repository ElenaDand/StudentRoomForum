<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ioanninanotes.aspx.cs" Inherits="StudentRoom.topics.ioannina.ioanninanotes" %>

<!doctype html>
<html>
<head>
<meta charset="utf-8">
<title>Πανεπιστήμιο Ιωαννίνων</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link href="base/jquery-ui.min.css" rel="stylesheet">
<link href="font-awesome.min.css" rel="stylesheet">
<link href="StudentRoom.css" rel="stylesheet">
<link href="ioanninanotes.css" rel="stylesheet">
...
<div id="button_notes" class="RollOverLayerSelected" style="left:126px;top:3px;width:116px;height:34px;z-index:5;" onclick="window.location.href='./ioanninanotes.aspx';return false;">
